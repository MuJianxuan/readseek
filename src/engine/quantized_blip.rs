...
// Based on BLIP model code from https://github.com/huggingface/candle,
...
use candle_transformers::models::quantized_blip_text as blip_text;
use candle_transformers::quantized_nn::{Linear, layer_norm, linear};
pub use candle_transformers::quantized_var_builder::VarBuilder;

pub type VisionConfig = candle_transformers::models::blip::VisionConfig;
pub type Config = candle_transformers::models::blip::Config;
